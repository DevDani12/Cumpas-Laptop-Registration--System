...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { path: "/ai", label: t("aiChat"),
      icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><path d="M12 2a10 10 0 0 1 10 10c0 3.5-1.8 6.6-4.5 8.5L12 22l-5.5-1.5A10 10 0 0 1 2 12 10 10 0 0 1 12 2z"/><path d="M8 12h8"/><path d="M12 8v8"/></svg> },
  ];
